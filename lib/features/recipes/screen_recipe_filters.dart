...
part 'screen_recipe_filters.g.dart';
...
class RecipeFiltersScreen extends StatefulWidget {
  ...
  @override
  State<RecipeFiltersScreen> createState() => _RecipeFiltersScreenState();
}

class _RecipeFiltersScreenState extends State<RecipeFiltersScreen> {
