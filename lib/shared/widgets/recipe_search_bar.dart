...
import '../../features/recipes/screen_recipe_filters.dart';

/// A search bar row with a debounced text field and a filter button.
///
/// The filter button opens [RecipeFiltersScreen] via:
      ...
      try {
        ...
        if (ctx.isMobile) {
          result = await showModalBottomSheet<RecipeFilter>(
            ...
            useSafeArea: true,
            builder: (context) => RecipeFiltersScreen(
    ...
    return Row(
      children: [
        ...
        Badge(
          ...
          label: Text('$nonSearchActiveCount'),
